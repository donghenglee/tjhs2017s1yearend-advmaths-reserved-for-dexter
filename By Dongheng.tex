...
\part 试证 
\[
8 + 88 + 888 + \ldots + \underbrace{888\ldots88}_{88'\text{s}} = \frac{8}{81}(10^{89} - 802)
\] 
\hfill (4分)
\begin{solution}
    考虑到
    \[
    \underbrace{99\ldots99}_{n'\text{s}}= 10^n - 1
    \]
    于是
    \begin{align*}
    8 + 88 + 888 + \cdots + \underbrace{888\ldots88}_{88'\text{s}} 
    &= \frac{8}{9}(9 + 99 + 999 + \cdots + \underbrace{99\ldots99}_{88'\text{s}}) \\
